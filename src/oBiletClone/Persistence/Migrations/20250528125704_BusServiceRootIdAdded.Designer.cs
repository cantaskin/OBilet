...
namespace Persistence.Migrations
{
    ...
    [Migration("20250528125704_BusServiceRootIdAdded")]
    partial class BusServiceRootIdAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4e68f7c7-1da5-4d82-a2f0-ce095d8ede7c"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@admin.io",
                            PasswordHash = new byte[] { 236, 177, 167, 156, 204, 128, 98, 249, 216, 22, 187, 203, 132, 235, 6, 127, 108, 240, 134, 16, 192, 197, 2, 40, 23, 155, 66, 209, 222, 231, 193, 219, 192, 10, 106, 71, 45, 107, 219, 228, 67, 214, 201, 40, 115, 38, 107, 27, 166, 88, 54, 123, 62, 131, 231, 62, 82, 201, 196, 228, 1, 25, 95, 193 },
                            PasswordSalt = new byte[] { 221, 174, 89, 65, 125, 215, 104, 130, 19, 191, 0, 216, 102, 69, 228, 221, 16, 192, 142, 60, 204, 168, 234, 44, 238, 138, 134, 98, 42, 108, 214, 54, 114, 174, 222, 88, 241, 179, 128, 112, 252, 253, 74, 181, 12, 202, 148, 81, 75, 218, 253, 199, 104, 26, 2, 145, 18, 182, 185, 59, 49, 53, 139, 237, 240, 184, 211, 242, 205, 157, 131, 93, 204, 238, 146, 104, 155, 186, 150, 114, 109, 72, 173, 212, 212, 168, 164, 106, 117, 227, 106, 15, 157, 85, 166, 207, 194, 119, 227, 89, 196, 9, 166, 53, 169, 158, 113, 214, 164, 107, 202, 58, 114, 92, 192, 33, 16, 110, 66, 108, 240, 174, 98, 95, 59, 106, 129, 181 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e13ec629-14e8-4f42-bc25-c4c6a910ed94"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("4e68f7c7-1da5-4d82-a2f0-ce095d8ede7c")
                        });
                });
