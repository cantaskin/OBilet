...
namespace Persistence.Migrations
{
    ...
    [Migration("20250528132720_BusServiceStationAdded")]
    partial class BusServiceStationAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("485833c9-7a29-4def-8728-de180f79d4b1"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@admin.io",
                            PasswordHash = new byte[] { 139, 162, 255, 169, 167, 102, 90, 190, 246, 103, 17, 121, 252, 72, 157, 191, 245, 237, 178, 211, 122, 213, 26, 17, 116, 175, 180, 217, 229, 154, 127, 174, 65, 142, 167, 24, 220, 78, 241, 89, 77, 224, 202, 24, 147, 59, 168, 234, 225, 218, 31, 167, 118, 230, 35, 70, 141, 44, 149, 140, 173, 216, 210, 194 },
                            PasswordSalt = new byte[] { 223, 230, 106, 152, 220, 212, 69, 79, 49, 195, 223, 157, 229, 31, 251, 217, 208, 12, 26, 82, 50, 167, 202, 203, 20, 68, 182, 194, 52, 187, 106, 186, 18, 206, 131, 10, 160, 196, 106, 123, 28, 124, 63, 110, 153, 116, 49, 249, 133, 163, 248, 102, 156, 227, 212, 137, 190, 106, 223, 134, 55, 73, 137, 111, 53, 34, 109, 244, 143, 72, 75, 208, 251, 53, 183, 244, 16, 173, 158, 188, 1, 32, 103, 238, 160, 82, 229, 225, 39, 16, 224, 155, 135, 113, 35, 137, 151, 131, 78, 19, 140, 216, 179, 203, 15, 86, 99, 79, 73, 249, 246, 154, 73, 17, 56, 77, 203, 133, 243, 20, 25, 96, 243, 85, 153, 174, 87, 61 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4cefd587-e3cc-4263-8f6e-d6bd0f0b7dd1"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("485833c9-7a29-4def-8728-de180f79d4b1")
                        });
                });
