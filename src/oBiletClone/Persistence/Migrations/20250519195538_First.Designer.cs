...
namespace Persistence.Migrations
{
    ...
    [Migration("20250519195538_First")]
    partial class First
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e94c130c-30fd-4254-8e0d-7252828a42ec"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@admin.io",
                            PasswordHash = new byte[] { 177, 26, 168, 15, 189, 86, 16, 198, 191, 201, 147, 246, 115, 155, 65, 237, 105, 154, 203, 122, 45, 70, 241, 150, 208, 207, 173, 170, 215, 88, 243, 65, 36, 208, 218, 239, 61, 108, 189, 255, 213, 121, 154, 75, 67, 241, 100, 109, 61, 82, 232, 141, 186, 130, 52, 227, 171, 180, 250, 201, 235, 87, 172, 155 },
                            PasswordSalt = new byte[] { 5, 3, 180, 82, 95, 89, 20, 237, 87, 67, 4, 4, 196, 202, 126, 137, 45, 79, 230, 218, 131, 83, 64, 105, 115, 210, 199, 11, 187, 247, 16, 111, 35, 168, 34, 207, 154, 227, 52, 62, 216, 17, 62, 26, 244, 96, 182, 65, 21, 53, 182, 127, 112, 129, 166, 4, 111, 80, 143, 147, 173, 206, 152, 4, 53, 191, 60, 73, 170, 212, 7, 88, 130, 136, 124, 87, 189, 204, 179, 150, 176, 147, 111, 60, 153, 7, 177, 191, 245, 227, 91, 117, 183, 252, 154, 208, 20, 235, 246, 179, 254, 121, 30, 100, 166, 145, 230, 107, 90, 57, 148, 190, 173, 77, 131, 66, 91, 168, 72, 5, 98, 162, 67, 78, 43, 175, 41, 69 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("274212f9-1379-4f4e-a429-073872b3b617"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("e94c130c-30fd-4254-8e0d-7252828a42ec")
                        });
                });
